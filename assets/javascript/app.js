var song = new Audio('assets/music/lineOfSight.m4p');
console.log(song);
song.load();

function play() {
	song.currentTime = 0.01;
	setTimeout(function(){song.play();},1);
}

var imagesURL = ['assets/images/barCrawl.jpg', 'assets/images/coachellaFour.jpg', 'assets/images/coachellaOne.jpg',
	'assets/images/coachellaThree.jpg', 'assets/images/coachellaTwo.jpg', 'assets/images/londonConcert.jpg','assets/images/londonSleeping.jpg'];
function carousel() {
